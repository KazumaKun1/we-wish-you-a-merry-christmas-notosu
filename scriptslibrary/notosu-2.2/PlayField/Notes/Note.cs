...
namespace StorybrewScripts
{
    ...
    public class Note
    {
        ...
        public Note(StoryboardLayer layer, OsuHitObject hitObject, Column column, double bpm, double offset, bool enableAdditive, bool isColored = false,double msPerPart = 40)
        {
            ...
            if (isColored == false)
            {
                ...
                {
                    case 1:
                        sprite = layer.CreateSprite(enableAdditive ? "sb/sprites/1-a.png" : "sb/sprites/1.png");
                        break;
                    case 2:
                        sprite = layer.CreateSprite(enableAdditive ? "sb/sprites/2-a.png" : "sb/sprites/2.png");
                        break;
                    case 3:
                        sprite = layer.CreateSprite(enableAdditive ? "sb/sprites/3-a.png" : "sb/sprites/3.png");
                        break;
                    case 4:
                        sprite = layer.CreateSprite(enableAdditive ? "sb/sprites/4-a.png" : "sb/sprites/4.png");
                        break;
                    case 12:
                        sprite = layer.CreateSprite(enableAdditive ? "sb/sprites/12-a.png" : "sb/sprites/12.png");
                        break;
                    case 16:
                        sprite = layer.CreateSprite(enableAdditive ? "sb/sprites/16-a.png" : "sb/sprites/16.png");
                        break;
                    default:
                        this.noteType = 1;
                        sprite = layer.CreateSprite(enableAdditive ? "sb/sprites/1-a.png" : "sb/sprites/1.png");
        ...
        public void Additive(double starttime, double endttime) {
            OsbSprite note = this.noteSprite;
            note.Additive(starttime, endttime);
        }
