...
namespace StorybrewScripts
{
    ...
    public class Column
    {
        ...
        public Column(double offset, ColumnType type, String receptorSpritePath, StoryboardLayer columnLayer, CommandScale scale, double starttime, double delta, bool enableAdditive)
        {
            this.offset = offset;
            this.type = type;
            this.scale = scale;
            ...
            receptor = new Receptor(receptorSpritePath, rotation, columnLayer, scale, starttime, this.type, delta, enableAdditive);
