...
namespace StorybrewScripts
{
    public class Receptor
    {
        ...
        public Receptor(String receptorSpritePath, double rotation, StoryboardLayer layer, CommandScale scale, double starttime, ColumnType type, double delta, bool enableAdditive)
        {
            ...
            if (enableAdditive) {
                receptorSprite.Additive(starttime, starttime);
            }
